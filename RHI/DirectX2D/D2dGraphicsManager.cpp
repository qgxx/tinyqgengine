...
HRESULT qg::D2dGraphicsManager::CreateGraphicsResources()
{
    HRESULT hr = S_OK;
...
int  qg::D2dGraphicsManager::Initialize()
{
    int result = 0;
...
void qg::D2dGraphicsManager::Tick()
{
}

void qg::D2dGraphicsManager::Finalize()
{
