...
HRESULT qg::D3d12GraphicsManager::CreateDescriptorHeaps() 
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateRenderTarget() 
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateDepthStencil()
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateVertexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateIndexBuffer(const Buffer& buffer)
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateTextureBuffer(const Image& image)
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateSamplerBuffer()
{
...
HRESULT qg::D3d12GraphicsManager::CreateConstantBuffer(const Buffer& buffer)
{
...
HRESULT qg::D3d12GraphicsManager::CreateGraphicsResources()
{
    HRESULT hr;
...
HRESULT qg::D3d12GraphicsManager::CreateRootSignature()
{
    HRESULT hr = S_OK;
...
HRESULT qg::D3d12GraphicsManager::InitializeShader(const char* vsFilename, const char* fsFilename) {
    HRESULT hr = S_OK;
...
HRESULT qg::D3d12GraphicsManager::InitializeBuffers()
{
    HRESULT hr = S_OK;
...
int  qg::D3d12GraphicsManager::Initialize()
{
    int result = 0;
...
void qg::D3d12GraphicsManager::Tick()
{
}

void qg::D3d12GraphicsManager::Finalize()
{
...
void qg::D3d12GraphicsManager::Clear()
{
}

void qg::D3d12GraphicsManager::Draw()
{
}