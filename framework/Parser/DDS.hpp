...
namespace qg {
    ...
    typedef enum qg_D3D10_RESOURCE_DIMENSION {
        D3D10_RESOURCE_DIMENSION_UNKNOWN    ,
        D3D10_RESOURCE_DIMENSION_BUFFER     ,
        D3D10_RESOURCE_DIMENSION_TEXTURE1D  ,
        D3D10_RESOURCE_DIMENSION_TEXTURE2D  ,
        D3D10_RESOURCE_DIMENSION_TEXTURE3D
    } qg_D3D10_RESOURCE_DIMENSION;

    typedef enum qg_D3DFMT {
    ...
    typedef struct {
        qg_DXGI_FORMAT     dxgiFormat;
        qg_D3D10_RESOURCE_DIMENSION    resourceDimension;
        uint32_t        miscFlag;
        uint32_t        arraySize;
        uint32_t        miscFlag2;
    } DDS_HEADER_DXT10;
