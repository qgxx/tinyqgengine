...
void qg::MemoryManager::Finalize()
{
...
Allocator* qg::MemoryManager::LookUpAllocator(size_t size)
{
...
void* qg::MemoryManager::Allocate(size_t size)
{
...
void* qg::MemoryManager::Allocate(size_t size, size_t alignment)
{
    uint8_t* p;
    size += alignment;
    Allocator* pAlloc = LookUpAllocator(size);
