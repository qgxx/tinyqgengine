...
vertex main0_out main0(main0_in in [[stage_in]], constant PerBatchConstants& _50 [[buffer(0)]], texture2d<float> terrainHeightMap [[texture(0)]], sampler terrainHeightMapSmplr [[sampler(0)]])
{
    main0_out out = {};
